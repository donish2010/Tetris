...
public final class Board extends Observable {
    ...
    public void moveDown() {
        ...
        if (isMoveDownLegal(myCurrentPiece)) {
...
//    }
     ...
     */
    private boolean isMoveDownLegal(final Piece thePiece) {
        boolean canPass = true;
        final int[][] blocks = ((AbstractPiece) thePiece).getBoardCoordinates();
    ...
    /**
     * Method that clones the current piece to create a ghost piece. 
     * Returns the coordinates of the ghost piece at the bottom of the 
     * board.
     * 
     * 
     * @return int[][] the ghost piece coordinates
     */
    public int[][] getGhostboardCoordinates() {
        

        Piece p = myCurrentPiece;
        
        try {
            p = ((AbstractPiece) myCurrentPiece).clone();
        ...
        int[][] ghost = ((AbstractPiece) p).getBoardCoordinates();
        

        while (isMoveDownLegal(p)) {
            p.moveDown();
            ghost = ((AbstractPiece) p).getBoardCoordinates();
    ...
    public void hardDrop() {
        while (isMoveDownLegal(myCurrentPiece)) {
            myCurrentPiece.moveDown();
        }
        freeze(); // this will notify observers
    }
